...
from .models import Venda, Eletricos, Hidraulico, Cliente, Vidro, Tinta, Esquadria, Madeira, Maquina, \
    Pedra, Ceramica, Coberta, Piso, Estrutura, Iluminacao, Ferramenta
